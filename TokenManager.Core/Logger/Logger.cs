...
namespace TokenManager.Core.Logger
{
   public class Logger
    {
        private static void Init()
        {
            ...
            target2.Encoding = Encoding.UTF8;
            ...
            target3.Encoding = Encoding.UTF8;
            ...
            target4.Encoding = Encoding.UTF8;
            ...
            target5.Encoding = Encoding.UTF8;
            ...
            target6.Encoding = Encoding.UTF8;
        ...
        {
            WriteLog(LogType.Trace, content);
        }
        ...
        public static string LogPath
        {
            get
            {
                ...
                absolutePath = !string.IsNullOrEmpty(AppSettingUtils.GetString("LogPath")) ? AppSettingUtils.GetString("LogPath") : (absolutePath.Substring(0, absolutePath.IndexOf("/bin") + 1) + "Logs/");
                try
                {
